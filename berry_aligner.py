...
def glob(glob_pattern, directoryname):
    ...
    for root, dirnames, filenames in os.walk(directoryname):
        for filename in fnmatch.filter(filenames, glob_pattern):
            ...
            name = absolute_filepath.rsplit('/sw2_expr/')[-1]
            names.append(name)
...
def aligner(exprs):
   ...
   # T3 = PairwiseAlignment(T2, mA, gp)
    ...
    A2.write_csv('/home/juicebox/Desktop/Acinis/CDFdata/sw2_csv/p50_s75_p3_p3_pe5_rt.csv', '/home/juicebox/Desktop/Acinis/CDFdata/sw2_csv/p50_s75_p3_p3_pe5_area.csv')
...
def main():
    ...
    folder_with_cdffiles = '/home/juicebox/Desktop/Acinis/CDFdata/sw2_expr'

    cdfs, names = glob(glob_pattern="*5075p5", directoryname= folder_with_cdffiles)
